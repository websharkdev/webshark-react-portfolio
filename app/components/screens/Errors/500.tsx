...
export const Body500: FC<Props> = (props) => {
  return (
    <Box
      sx={{
        width: 'calc(100% - 68px)',
          ...
          <Box className="error-titleBox-container">
            <Box className="error-textBox">
              ...
              <Typography variant="body2" className="error-text">
                Some things went wrong. Server-side error occurred. Try again litle bit later.
              </Typography>
            </Box>
            <Box className="error-titleBox">
              <Typography component="div" width={750}>
                <span className="error-title">500 - Server-side error occurred</span>
