    ...
    aids: [
      {
        ...
        text: 'military assistance to the army, military training',
        read_more: [
          {
            id: '0',
            name: 'Wikipedia',
            href: 'https://en.wikipedia.org/wiki/Come_Back_Alive',
          },
          {
            id: '1',
        ...
        image: 'https://i.ibb.co/XLTyLvC/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://savelife.in.ua/en/',
      ...
      },
      {
        id: '1',
        name: 'Come Back Alive',
        text: 'military assistance to the army, humanitarian assistance to civilians',
        read_more: [
          {
            id: '0',
            name: 'Official website',
        ...
        image: 'https://i.ibb.co/SRc6bJ3/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://prytulafoundation.org/',
      ...
      },
      {
        ...
        text: 'humanitarian aid to the army, provision of tactical medicine and means of communication, evacuation, development of society',
        read_more: [
          {
            id: '0',
            name: 'Wikipedia',
            href: 'https://en.wikipedia.org/wiki/Razom',
          },
          {
            id: '1',
            name: 'Official website',
        ...
        image: 'https://i.ibb.co/KhDCHVp/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://www.razomforukraine.org/',
      ...
      },
      {
        id: '3',
        name: 'UNITED 24',
        text: 'defense and demining, humanitarian and medical assistance, reconstruction',
        read_more: [
          {
            id: '0',
            name: 'Wikipedia',
            href: 'https://en.wikipedia.org/wiki/United24',
          },
          {
            id: '1',
            name: 'Official website',
        ...
        image: 'https://i.ibb.co/fDq5sjw/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://u24.gov.ua/en',
      ...
      },
      {
        id: '4',
        name: 'KSE Foundation',
        text: 'protection, tactical medicine, humanitarian aid. ',
        read_more: [
          {
            id: '0',
            name: 'Official website',
            href: 'https://kse.ua/we-save-lives/',
          },
        ],
        image: 'https://i.ibb.co/fnkKv26/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://u24.gov.ua/en',
      ...
      },
      {
        id: '5',
        name: 'KOLO',
        text: 'protective and technical assistance to the army',
        read_more: [
          {
            id: '0',
            name: 'Official website',
        ...
        image: 'https://i.ibb.co/x8wk2d2/Frame-18.png',
        link: {
          id: '0',
          name: 'help.',
          href: 'https://www.koloua.com/en/',
